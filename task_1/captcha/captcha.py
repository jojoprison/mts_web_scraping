...
def save_captcha(captcha_json):
    ...
    if captcha_list_json:
        json_len = len(captcha_list_json)
        captcha_list_json[f'captcha_{json_len + 1}'] = captcha_json
    else:
    ...
    return f'user_agent_saved: {captcha_json}'
